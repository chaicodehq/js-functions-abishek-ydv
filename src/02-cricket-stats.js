...
export const getPlayerCard = (player) => {
  if(typeof player !== 'object' || player === null || player === undefined || !player.hasOwnProperty('name')) return null;
  ...
  let isAllRounder2 = isAllRounder(battingAvg, economy);
  return {
    name,
    strikeRate,
    economy,
    battingAvg,
    isAllRounder: isAllRounder2
  }
};
